...
\section{Potenzfunktion und Wurzelfunktion}
	\subsection{Quadratfunktion $z^2$ und Wurzelfunktion $\sqrt{z}$}
		...
		\begin{minipage}[]{0.5\textwidth}
			\centering
			\scalebox{1.8}{\includegraphics[width=0.5\textwidth]{pics/KomplexeZahlen/QuadratFunktion.png}}
	...
	\subsection{Potenzfunktion $z^n$ und Wurzelfunktion $\sqrt[n]{z}$}
		...
		\begin{minipage}[]{0.5\textwidth}
			\centering
			\scalebox{1.8}{\includegraphics[width=0.5\textwidth]{pics/KomplexeZahlen/PotenzFunktion.png}}
			\captionof{figure}{Quelle: Skript KomFour}
		\end{minipage}
