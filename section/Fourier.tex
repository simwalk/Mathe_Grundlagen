		...
		\subsubsection{Symmetrie}
			\begin{minipage}[]{0.5\textwidth}
				\begin{tabular}{|c|c|}
					...
					\hline
					\scalebox{0.45}{\input{tikz/FourierReihe/GeradeFunktion.tex}} & \scalebox{0.45}{\input{tikz/FourierReihe/UngeradeFunktion.tex}}\\[3pt]
					\hline
		...
		\subsection{Konvergenz der Fourierreihen}
			\subsubsection{Optimalität der Fourierreihe (Approximation)}
				\begin{minipage}[b]{0.55\textwidth}
					...
					\fbox{$\displaystyle \left|\left|f - g\right|\right| = \sqrt{\dfrac{2}{T} \int\limits_{0}^{T} \left[ f(t) - g(t) \right]^2 dt}$}\\[3pt]
					Abstand $||f - g||$ zweier Funktionen kann klein sein, obschon sich die Funktionswerte stellenweise stark unterscheiden!
				\end{minipage}
				\begin{minipage}[]{0.45\textwidth}
					\scalebox{0.8}{\input{tikz/FourierReihe/FourierAbstand.tex}}\\[3pt]
				\end{minipage}
			...
			\subsubsection{Punktweise Kovergenz von Fourierreihen (Satz von Dirichlet)}
				...
				\begin{minipage}[]{0.35\textwidth}
					\scalebox{0.8}{\input{tikz/FourierReihe/FourierDirichlet.tex}}\\[3pt]
				\end{minipage}
			...
			\subsubsection{Gibbs-Phänomen}
				...
				\end{minipage}
				\begin{minipage}[]{0.35\textwidth}
					\scalebox{0.8}{\input{tikz/FourierReihe/FourierGibbsPhaenomen.tex}}\\[3pt]
				\end{minipage}
