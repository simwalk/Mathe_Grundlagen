\section{Spektren}
	...
	\subsection{Zeitbereich und Frequenzbereich}
		\begin{minipage}[]{0.5\textwidth}
			\scalebox{1.7}{\includegraphics[width=0.5\textwidth]{pics/Spektren/ZeitUndFrequenzbereich1.png}}\\[3pt]
			\scalebox{1.7}{\includegraphics[width=0.5\textwidth]{pics/Spektren/ZeitUndFrequenzbereich2.png}}
		\end{minipage}
		\begin{minipage}[]{0.5\textwidth}
			\scalebox{1.7}{\includegraphics[width=0.5\textwidth]{pics/Spektren/ZeitUndFrequenzbereich3.png}}
			\scalebox{1.7}{\includegraphics[width=0.5\textwidth]{pics/Spektren/ZeitUndFrequenzbereich4.png}}
		\end{minipage}
