\section{Komplexe Zahlen}
	\subsection{Definition}
		...
		\begin{minipage}[t]{0.5\textwidth}
			...
			\fbox{$z = \underbrace{z_{1}}_{\text{Realteil}} + \underbrace{z_{2}}_{\text{Imaginärteil}} \cdot j$}\\[3pt]
			$j = \text{imaginäre Einheit}$
		\end{minipage}
		\begin{minipage}[t]{0.5\textwidth}
			\textbf{Komplexe Zahl in Polarform:}\\[3pt]
			\fbox{$z = \underbrace{\left| z \right|}_{Betrag} \cdot \underbrace{[cos(\varphi) + j \cdot sin(\varphi)]}_{Winkel} = r \cdot cjs(\varphi)$}\\[3pt]
		...
		\end{tabular}
		\fbox{$\displaystyle \varphi = \left\{
				\begin{array}{ll}
					arctan\left(\dfrac{z_{2}}{z_{1}}\right) & \text{für: } z_{1} \geq 0\\[3pt]
				...
				\left\{
				\begin{array}{ll}
					\; \; \: arctan\left(\dfrac{z_{1}}{r_{}}\right) & \text{für: } z_{2} \geq 0\\[3pt]
					-arctan\left(\dfrac{z_{1}}{r_{}}\right) & \text{für: } z_{2} < 0
				\end{array}
				\right.
			$}\\[3pt]
	...
	\subsection{Potenzen und n-te (Einheits-)Wurzeln}
		...
		\subsection{Nullstellen von Polynomen}
			...
			\subsubsection{Berechnung der Nullstellen}
				...
				\end{minipage}
				\begin{minipage}[]{0.3\textwidth}
					\scalebox{0.7}{\input{tikz/KomplexeZahlen/NullstellenKreis.tex}}
				\end{minipage}
			...
			\subsection{Komplexe Exponential- und Logarithmusfunktionen}
				...
				\subsubsection{Logarithmusfunktionen $\operatorname{Ln}$}
					...
					\begin{minipage}[t]{0.6\textwidth}
						...
						\fbox{$\operatorname{Ln}(a)=\ln (|a|)+\mathrm{j}(\arg (a)+2 k \pi)$}
