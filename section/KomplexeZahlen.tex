...
\begin{minipage}[t]{0.5\textwidth}
	\subsection{Division in Polarform}
		...
		\end{tabular}\\[3pt]
		\scalebox{1}{\input{tikz/KomplexeZahlen/KomplexDiv.tex}}\\[3pt]
\end{minipage}

\subsection{Planare Geometrie mit komplexen Zahlen}
	\begin{minipage}[c]{0.5\textwidth}
		\textbf{Gerade:}\\[3pt]
		\scalebox{1}{\input{tikz/KomplexeZahlen/KomplexGer.tex}}
	\end{minipage}
	\begin{minipage}[c]{0.5\textwidth}
		\textbf{Kreis:}\\[3pt]
		\scalebox{1}{\input{tikz/KomplexeZahlen/KomplexKreis.tex}}
	\end{minipage}
