...
\subsection{Potenzen und n-te (Einheits-)Wurzeln}
	\subsubsection{Potenzen}
		\begin{tabular}{m{7cm}m{7cm}}
			\fbox{$z^n = \underbrace{z \cdot z \cdot \cdots \cdot z}_{\text{n-Faktoren}}, \quad z^0 = 1, \quad z^-n = \dfrac{1}{z^n}$}
			&
			\fbox{$
				\begin{array}{lll}
	...
	\subsection{Nullstellen von Polynomen}
		...
		\subsection{Parameter- und Koordinatengleichung}
			...
			\begin{minipage}[t]{0.8\textwidth}
				...
				\begin{tabular}{llll}
					\fbox{$z = \operatorname{z}\left( r \right) = r + \mathrm{j} c_2$} & $\Rightarrow[]{\operatorname{f}\left( z \right)}$ & \fbox{$w = \operatorname{w}\left( r \right) = \operatorname{f}\left( \operatorname{z}\left( r \right) \right) = \operatorname{f}\left( r + \mathrm{j} c_2 \right)$}\\
				\end{tabular}
				\textbf{senkrechte Gitternetzlinien durch Punkt $(c_1; 0)$:}
				\begin{tabular}{llll}
					\fbox{$z = \operatorname{z}\left( r \right) = c_1 + \mathrm{j} r$} & $\Rightarrow[]{\operatorname{f}\left( z \right)}$ & \fbox{$w = \operatorname{w}\left( r \right) = \operatorname{f}\left( \operatorname{z}\left( r \right) \right) = \operatorname{f}\left( c_1 + \mathrm{j} r \right)$}\\
				\end{tabular}
			\end{minipage}
